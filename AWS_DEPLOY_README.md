...
**Server URL:** http://3.151.143.63/  
**Direct app:** http://3.151.143.63:8000
...
This uploads this entire folder to the server and runs the deploy there. Your app will be at http://3.151.143.63:8000 (or through your proxy at http://3.151.143.63/).
...
| File | Use |
|------|-----|
| **UPLOAD_AND_DEPLOY_TO_AWS.ps1** | Run from your PC: uploads this project to 3.151.143.63 and deploys (needs SSH key). |
...
2. On the EC2 instance:
   ...
   - **Linux:** `./deploy_aws.sh`
3. App listens on `0.0.0.0:8000` → http://3.151.143.63:8000

If you use nginx so that http://3.151.143.63/ (port 80) goes to the app, point the proxy to `127.0.0.1:8000`.
